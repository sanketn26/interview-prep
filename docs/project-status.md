...
- Storytelling pass — implemented across the first-release slice, all design and LLD exercises, DSA patterns, labs, vendor databases, networking, cloud Needs-review tutorials, and growth-mindset pages. The contract, reproducible scanner/artifact, truthfulness rules, genre exemptions, and reader-test protocol live in [`storytelling-pass.md`](storytelling-pass.md). Reader outcome validation remains a post-merge measurement; structural compliance is not treated as proof of engagement.
