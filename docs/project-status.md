...
- Storytelling pass — reader feedback that tutorials do not hold attention. Scan, verdict, and phased rewrite plan: [`storytelling-pass.md`](storytelling-pass.md). Phases 0–3 (contract + first-release concepts + flagship exercises + DSA/behavioural opens) are required before the long-tail encyclopedia pages. Plan only as of 2026-09-15; no page rewrites landed yet.
